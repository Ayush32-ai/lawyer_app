...
import 'lawyer_profile_edit_screen.dart';
import 'availability_screen.dart';

class LawyerDashboardScreen extends StatelessWidget {
  final String location;

  const LawyerDashboardScreen({super.key, required this.location});
            ...
            onSelected: (value) async {
              if (value == 'logout') {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => const LawyerProfileEditScreen(),
                  ),
                );
              ...
              PopupMenuItem<String>(
                ...
                child: Row(
                  children: [
                    ...
                    Text('View Profile', style: GoogleFonts.roboto()),
                  ],
                ),
              ),
              PopupMenuItem<String>(
